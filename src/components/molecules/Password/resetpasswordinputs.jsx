...
const ResetPasswordInputs = ({hasUpper, hasLower, hasSymbol, hasNumber, handleFormSubmit, error, serverError,
                              hasEightChar, match, value, validationError, currentError, current,
        ...
        <div className='inputs'>
            <div> 
                ...
                <CustomInput
                    ...
                    {serverError && <ToolTip toolTipIcon={<ErrorOutlineIcon className="icon" />} toolTipText="Invalid Password" toolTipColor="#D73D3D"/>}
            </div>
