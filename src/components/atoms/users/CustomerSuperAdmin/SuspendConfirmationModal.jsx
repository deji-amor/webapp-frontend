...
import { Button, styled, Dialog, DialogContent, Box } from "@mui/material";
import WarningIcon from "../../../../assets/user/CustomerOnboarding/warning.png";

const SuspendConfirmationModal = ({ open, onClose, onConfirm }) => {
		...
		<Dialog open={open} onClose={onClose} fullWidth maxWidth="xs">
			...
			>
				...
				<div>
					...
					<Text>Are you sure you want to suspend this customer?</Text>
				</div>
				<Box
					sx={{
						display: "flex",
