...
const TicketRow = ({ ticket }) => {
	...
	return (
		<tr
			...
			className="border-b-2 border-b-[#ECECEC] hover:bg-[#F1F2FD] transition duration-300 ease-in-out cursor-pointer"
		>
			...
			<td scope="ro" className="py-4 px-1">
				<TicketTypeTableBodyText className="max-w-[12rem] truncate">
					{ticket?.ticket_form}
				</TicketTypeTableBodyText>
			</td>
			<td scope="ro" className="py-4 px-1">
				<TicketTypeTableBodyText className="max-w-[16rem] truncate">
					{ticket?.email}
				</TicketTypeTableBodyText>
			</td>
			<td scope="ro" className="py-4 px-1">
