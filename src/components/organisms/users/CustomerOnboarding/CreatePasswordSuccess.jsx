...
const CreatePasswordSuccess = () => {
	...
	const navigateToLoginCustomer = (e) => {
		e.preventDefault();
	...
	return (
		<ForgotPasswordRecoverySuccessWrapper width="550px">
			<PasswordSuccess
				...
				title="Your Password Has Been Created Successfully."
				iconSize="56px"
			...
			<CustomButton butText="Proceed to Login" butWidth="80%" onClick={navigateToLoginCustomer} />
